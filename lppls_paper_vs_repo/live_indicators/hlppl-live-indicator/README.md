# HLPPL Live Bubble Indicator

Hyped Log-Periodic Power Law bubble score (Cao-Shao-Yan-Geman, arXiv:2510.10878): rolling 7-parameter LPPL calibration, volatility-confined residual score, episode labelling and the paper's threshold trading rules.
...
Rolling 126-bar windows; each window is calibrated with a bounded 7-parameter least-squares LPPL fit (10 multistart seeds). The endpoint residual is causally normalised (eps/max|eps|) and combined with the hype proxy into the BubbleScore.
