# HLPPL-DAE-KAN Live Bubble Indicator

HLPPL bubble score with a KAN-fitted trajectory on autoencoder-denoised windows - the full neural HLPPL pipeline.
...
KAN-fitted trajectory on autoencoder-denoised windows - the full neural pipeline.
